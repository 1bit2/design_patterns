...
- [ ] 策略 (Strategy) — 算法族可互换
- [ ] [命令 (Command)](behavioral/command/) — 把请求封装为对象，可参数化/撤销/组合 `代码 ✅`
- [ ] 模板方法 (Template Method) — 定义骨架，子类填充步骤
- [ ] [迭代器 (Iterator)](behavioral/iterator/) — 顺序访问聚合元素 `代码 ✅`
- [ ] 状态 (State) — 状态改变行为
- [ ] 职责链 (Chain of Responsibility) — 请求沿链传递直到有人处理
- [ ] [访问者 (Visitor)](behavioral/visitor/) — 不修改类的前提下新增操作 `代码 ✅`
- [ ] [备忘录 (Memento)](behavioral/memento/) — 保存和恢复对象状态 `代码 ✅`
